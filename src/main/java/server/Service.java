...
public class Service {
    ...
    public static void sendclonechar(final User p, final User top) {
        try {
            ...
            Item item10 = p.nj.clone.ItemBody[1];//bienhinh
            if (item10 != null) {
    ...
    public static void CharViewInfo(final User p, boolean sendEff) {
        ...
        try {
            ...
            if (item10 != null) {
                if (item10.id == 1021) {//dao
                    msg.writer().writeShort(165);
                } else if (item10.id == 1020) {//cung
                    msg.writer().writeShort(166);
                } else if (item10.id == 1017) {//kiem
                    msg.writer().writeShort(167);
                } else if (item10.id == 1022) {//quat
                    msg.writer().writeShort(168);
                } else if (item10.id == 1019) {//kunai
                    msg.writer().writeShort(169);
                } else if (item10.id == 1018) {//tieu
                    msg.writer().writeShort(170);
                } else {
                    msg.writer().writeShort(-1);
                }
            } else {
