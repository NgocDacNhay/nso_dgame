...
public class Body implements ISoloer {
    ...
    public short partHeadCheck(Item[] item){
        if(item.length != 0){
            for (Item item1 : item) {
                if(item[11] == null){
                    return this.c.head;
                }
                return ItemDataId(item[11].id).part;
            }
        }
        return -1;
    }
    ...
    public short partHead() {
        ...
        if (this.c.ItemBodyHide[0] == null) {
            return this.partHeadCheck(this.ItemBody);
        }
        ...
        if (this.ItemBody[11].id == 745) {//mn chuột
            return 264;
        }

        if (this.ItemBody[11].id == 541)//tt
            return 185;
        if (this.ItemBody[11].id == 542)//st
            return 188;
        if (this.ItemBody[11].id == 774)//santa clause
            return 267;
        if (this.ItemBody[11].id == 786)//sumimura
            return 270;
        if (this.ItemBody[11].id == 787)//yukimura
            return 276;
        return ItemDataId(this.ItemBody[11].id).part;
    }
    ...
    public short partBody() {
        if (this.partHead() == 258) {//jack hollow
            return 259;
        }
        if (this.partHead() == 264) {//mn chuột
            return 265;
        }
        if (partHead() == 185)//tt
            return 186;
        if (partHead() == 188)//st
            return 189;
        if (partHead() == 267)//santa
            return 268;
        if (partHead() == 270)//sumi
            return 271;
        if (partHead() == 276)//yuki
            return 277;
        ...
        if (partHead() == 44 || partHead() == 53 || partHead() == 65) {//3 ông thầy
            return (short) (partHead() + 1);
        }
        if (partHead() == 96) {//jaian
            return 94;
        }
    ...
    public void updatePk(final int num) {
        if (this.c.isTaskDanhVong == 1 && this.c.taskDanhVong[0] == 5 && num > 0 && this.c.nhiemvuDV) {
    ...
    public int eff10buffHP() {
        int efHP = this.getPramItem(154);
        return efHP;
    }
    ...
    public int getPotential(final int i) {
        ...
        potential = potential * (100 + this.getPramItem(58)) / 150;
    ...
    public int getPramItem(final int id) {
        ...
        for (Item caitrang : this.c.ItemBodyHide) {
            if (caitrang != null) {
                for (Option option : caitrang.option) {
                    if (option.id == id) {
                        param += option.param;
                    }
                }
